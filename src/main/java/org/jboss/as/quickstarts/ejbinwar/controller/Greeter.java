...
import org.jboss.as.quickstarts.ejbinwar.dao.dto.Report;
...
public class Greeter implements Serializable {
    ...
    public String getMessage() {
        ...
        Report report = client.target("http://localhost:8080/api/report" +
                "?period=month&topProductsCount=5&topUsersCount=5&minStock=5")
                .request().get(Report.class);
